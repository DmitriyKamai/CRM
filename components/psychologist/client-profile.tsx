    ...
    <div className="space-y-4 min-w-0 w-full">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        >
          <SelectTrigger
            className={cn(
              "w-auto min-w-[180px] h-8 rounded-md border-0 px-3 text-xs font-semibold shadow-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:ring-ring relative [&>*:first-child]:relative [&>*:first-child]:z-0 [&>*:first-child]:flex-1 [&>*:first-child]:min-w-0 [&>*:first-child]:flex [&>*:first-child]:justify-center [&>*:first-child]:text-center [&>svg]:relative [&>svg]:z-10 [&>svg]:shrink-0 [&>svg]:ml-1",
              currentStatus
