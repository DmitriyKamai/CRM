          ...
          <div className="space-y-3">
            ...
            {hasApple ? (
              ...
              <Button
                ...
                onClick={async () => {
                  await fetch("/api/auth/oauth-link-intent", { method: "POST" });
                  signIn("apple", { callbackUrl: "/psychologist/settings" });
                }}
              >
                <span className="flex items-center gap-1">
