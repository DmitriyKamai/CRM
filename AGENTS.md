...
- **Модель ИИ:** по завершении выполненной задачи в **конце** ответа добавь строку **Модель:** с названием из контекста сессии; если оно не передано — укажи, что модель в метаданных не указана, **без выдумывания** имени.
